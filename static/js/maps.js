...
(function($){
    ...
    function mainMap() {
      ...
      // Locations
      var locations = [
        [ locationData('listing-detail-large.html','upload/info1.jpg',"Fifteen Restaurant & Cheese bar", 'Restaurant', 'Open', '1149 3rd St (Wilshire), London', '3', '8.5'), 17.046357087505065, 74.260674872695, 1, '<i class="la la-cutlery"></i>'],
      ...
      var map = new google.maps.Map(document.getElementById('map'), {
        mapId: 'd65267aba5be06c3',
        zoom: zoomLevel,
        scrollwheel: scrollEnabled,
        center: new google.maps.LatLng(17.046357087505065, 74.260674872695), //51.5344894,-0.1370057
